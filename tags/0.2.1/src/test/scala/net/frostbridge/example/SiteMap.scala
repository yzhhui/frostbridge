...
* scala> SiteMapExample("src/test/resources/sitemap.xml")
* scala> SiteMapExample("src/test/resources/sitemap.xml", false) // to only time the processing
*
...
// =========================== Define the pattern ===========================
	...
	val siteMapPattern: Pattern[SiteMap] =
	{
		...
		// Here we define the text element patterns.  The text pattern factory method accepts a NameClass instance
		...
		//   type that the text element corresponds to.
